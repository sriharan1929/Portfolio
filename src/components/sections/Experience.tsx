...
export const Experience = () => (
  <section id="experience" className="py-28 px-8 bg-bg-warm-secondary">
    <div className="max-w-[1100px] mx-auto">
      <FadeIn>
        <SectionHeading label="// work.experience" title="Hands-on in the field." />
      </FadeIn>
      <FadeIn delay={100}>
        <div className="p-10 rounded-3xl bg-bg-warm border border-[#f0ddc8] max-w-[780px] shadow-[0_2px_16px_rgba(194,97,26,0.07)]">
